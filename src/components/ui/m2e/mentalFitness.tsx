...
const mentalExercises = [
    {
        ...
        description:
            "Try this meditation at bedtime to follow Chris's voice into a deep sleep.",
        duration: '16 mins',
    ...
    },
    {
        ...
        description:
            'Discover a simple technique to find focus in high-stress situations.',
        duration: '4 mins',
        trainer: 'Tahl Rinsky',
    ...
    },
    {
        ...
        description:
            'Engage your senses to bring your awareness to the present moment.',
        duration: '5 mins',
        trainer: 'Emma Stone',
    ...
    },
    {
        ...
        description:
            'Spend a few minutes writing down things you are grateful for each day.',
        duration: '10 mins',
    ...
    },
    {
        ...
        description:
            'Visualize a peaceful place to promote relaxation and reduce stress.',
        duration: '15 mins',
    ...
    },
    {
        ...
        description:
            'Repeat positive affirmations to boost self-esteem and confidence.',
        duration: '7 mins',
        trainer: 'Brené Brown',
    ...
    },
    {
        ...
        description:
            'Learn to identify and release pent-up emotions through movement.',
        duration: '20 mins',
...
const MentalFitness = () => {
    ...
    const startExercise = (index: number) => {
        toast.success(
            `You have started ${mentalExercises[index].title}`,
            toastStyles
        );
    };
        ...
        <div className="w-full py-10 p-4 ">
            ...
            >
                {mentalExercises.map((exercise, idx) => (
                    <SwiperSlide
                        key={exercise.id}
                        className="bg-white min-h-[500px] relative p-4 rounded-lg shadow-md flex-shrink-0 flex flex-col justify-between"
                    >
                        <Image
                            src={exercise.image}
                            alt={exercise.title}
