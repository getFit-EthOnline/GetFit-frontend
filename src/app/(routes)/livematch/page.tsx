...
const Page = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row w-full px-4 lg:px-16 py-10 gap-y-10 lg:gap-x-16">
            <div className="flex flex-col gap-y-10 items-center max-w-[60%]">
                <div className="bg-white p-3 ">
                    ...
                    <div className="flex items-center justify-between py-5">
                        ...
                        <div className=" flex  gap-x-2">
                            <div className=" flex bg-neutral-400 w-fit px-3 py-1 rounded-lg text-slate-100 gap-x-7">
                                <div className="flex group gap-x-1 ">
                                    <svg
                                    ...
                                    <span className=" border-r-2 border-slate-600 pr-4 ">
                                        100K
                                    </span>
                                </div>
                                <div>
                            ...
                            <div className="flex bg-neutral-400 w-fit px-3 py-1 rounded-lg text-slate-100 gap-x-2">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
